...
void FrameDrawer::SetBorderRect(RECT windowRect, COLORREF rgb, float alpha, int thickness, float radius)
{
    ...
    newSceneRect.borderColor = ConvertColor(rgb, alpha);
    ...
    const bool cornersUpdated = (m_sceneRect.rect != NULL) != (newSceneRect.rect != NULL) || (m_sceneRect.roundedRect != NULL) != (newSceneRect.roundedRect != NULL);
